...
Task: Test screen-clamped centered movement speed on B012
<!-- /STATUS -->
...
- Commit checkpoint: WebGL resource loading, mobile safe-area UI, physics tuning, build marker, AIT/WebGL notes, AIT WebGL build settings, Korean WebGL font fallback, free-only rescue flow, floor/parcel friction tuning, and softened falling-box impact were split into focused Korean commits through `ceba02c 낙하 충격 완화로 박스 밀림 조정`. The worktree was clean immediately after that commit checkpoint.
