...
public sealed class BoxStackPrototypeConfig : ScriptableObject
{
    ...
    private static readonly StageSettings[] DefaultStages =
    {
        ...
        new StageSettings(3, 6, "BBWBBB", 0.85f, 0.85f),
        new StageSettings(4, 6, "BTBBWB", 0.90f, 0.90f),
        new StageSettings(5, 7, "BBWBTBB", 0.95f, 0.95f),
        new StageSettings(6, 7, "WBBTBBW", 1.00f, 1.00f),
        new StageSettings(7, 8, "BBTBWBBB", 1.00f, 1.00f),
        new StageSettings(8, 8, "WBTBBWBT", 1.05f, 1.00f),
        new StageSettings(9, 8, "BTTBWBBW", 1.05f, 1.05f),
        new StageSettings(10, 9, "BBWTBBWBB", 1.10f, 1.05f),
        new StageSettings(11, 9, "WTBBTBWBB", 1.10f, 1.10f),
        new StageSettings(12, 9, "BWBTWBTBB", 1.15f, 1.10f),
        new StageSettings(13, 10, "BBTWBTBWBB", 1.15f, 1.15f),
        new StageSettings(14, 10, "WBTBTWBBTB", 1.20f, 1.15f),
        new StageSettings(15, 10, "BTWBBTWTBB", 1.20f, 1.20f),
        new StageSettings(16, 11, "WBBTWBTBWBB", 1.25f, 1.20f),
        new StageSettings(17, 11, "BTBWTBBWTBB", 1.25f, 1.25f),
        new StageSettings(18, 12, "BWTBBWTBTWBB", 1.30f, 1.25f),
        new StageSettings(19, 12, "WTBTWBBTWBTB", 1.35f, 1.30f),
        new StageSettings(20, 12, "BTWTBWTBWTBB", 1.40f, 1.30f)
    };
