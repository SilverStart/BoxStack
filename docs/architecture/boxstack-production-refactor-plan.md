...
마지막 갱신: 2026-06-05
런타임 마커: B100
상태: Stage 4 drop physics split implemented and accepted
...
- 박스 생성 factory와 비주얼 적용 흐름 분리는 아직 남아 있다.
...
B098/B099/B100처럼 먼저 책임만 작게 나누는 방향을 유지한다. 다음 후보는 4단계의 남은 부분인 박스 생성 factory/비주얼 적용 흐름 분리이며, 폴더/네임스페이스 rename은 Unity 참조 churn이 크므로 실제 책임 분리가 더 진행된 뒤 최종 정리로 넘긴다.
